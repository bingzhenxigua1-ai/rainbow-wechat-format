...
agent_created: true
description: 当用户需要生成“湖南科技大学”风格的微信公众号封面、首图、小封面、兼顾大小封面或校园新媒体配图时使用。触发词：湖南科技大学封面、HNUST 封面、科大封面、湖南科大公众号封面。
---
...
该账号封面特征鲜明：高频使用 HNUST 品牌字母、校徽蓝、校园红砖建筑与湖景，风格横跨活泼拼贴、手绘插画、实景新闻、清新扁平插画和城市旅行拼贴五大方向。

## 触发条件

在以下任一情况触发本 skill：

- 用户提到“湖南科技大学封面”“HNUST 封面”“科大封面”
- 用户上传湖南科技大学公众号封面截图并要求模仿风格
- 用户希望生成“校园新媒体风”“高校公众号风”封面且明确指向湖南科技大学
...
根据用户主题推荐以下五种湖南科技大学公众号常见风格之一。如用户未指定风格，给出 2-3 个建议并等待选择。

| 风格 | 关键词 | 适用主题 |
|---|---|---|
| 活泼拼贴风 | 彩虹背景、表情包、生活贴纸、HNUST | 开学、社团、美食、轻松话题 |
...
5. 必须出现的元素（如 HNUST、校徽、特定建筑、特定配色）
6. 需要避免的内容
...
主题和文案：【内容摘要】。
视觉风格：湖南科技大学公众号【风格名称】，【风格描述】。
画面元素：必须包含 HNUST 字样、【其他元素】。
色彩：【配色描述】。
避免内容：【限制或无】。
...
主题和文案：【短文案或无文字】。
视觉风格必须与左侧大封面统一，为湖南科技大学公众号【风格名称】。
画面元素：【核心主体、HNUST 字母、校徽图形或图标】。
避免内容：【限制或无】。
...
```
A vibrant WeChat official account cover for Hunan University of Science and Technology (HNUST), 900x383 px. 
Theme: 【主题】. 
...
Big bold decorative text "HNUST" somewhere prominent. 
...
```
A hand-drawn illustration style WeChat cover for HNUST, 900x383 px. 
Theme: 【主题】. 
Style: cute chibi students, speech bubbles, warm orange background, doodle rainbows, friendly campus atmosphere. 
Decorative "HNUST" letters integrated into illustration. 
...
```
A cinematic campus photo WeChat cover for HNUST, 900x383 px. 
Theme: 【主题】. 
...
- `references/style-guide.md`：湖南科技大学公众号封面详细风格指南，含配色、字体、构图、五种风格变体。
